...
func generateLocalProtos() {
	...
	dirs := []struct {
		...
		pkgPaths: map[string]string{"cmd/protoc-gen-go/testdata/nopackage/nopackage.proto": "github.com/taogames/protobuf-go/cmd/protoc-gen-go/testdata/nopackage"},
...
func generateRemoteProtos() {
	...
	files := []struct{ prefix, path, goPkgPath string }{
		...
		// Conformance protos.
		{"", "conformance/conformance.proto", "github.com/taogames/protobuf-go/internal/testprotos/conformance;conformance"},
		{"src", "google/protobuf/test_messages_proto2.proto", "github.com/taogames/protobuf-go/internal/testprotos/conformance;conformance"},
		{"src", "google/protobuf/test_messages_proto3.proto", "github.com/taogames/protobuf-go/internal/testprotos/conformance;conformance"},
		...
		//{"benchmarks", "benchmarks.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks;benchmarks"},
		//{"benchmarks", "datasets/google_message1/proto2/benchmark_message1_proto2.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message1/proto2;proto2"},
		//{"benchmarks", "datasets/google_message1/proto3/benchmark_message1_proto3.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message1/proto3;proto3"},
		//{"benchmarks", "datasets/google_message2/benchmark_message2.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message2;google_message2"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_1.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_2.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_3.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_4.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_5.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_6.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_7.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message3/benchmark_message3_8.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message3;google_message3"},
		//{"benchmarks", "datasets/google_message4/benchmark_message4.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message4;google_message4"},
		//{"benchmarks", "datasets/google_message4/benchmark_message4_1.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message4;google_message4"},
		//{"benchmarks", "datasets/google_message4/benchmark_message4_2.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message4;google_message4"},
		//{"benchmarks", "datasets/google_message4/benchmark_message4_3.proto", "github.com/taogames/protobuf-go/internal/testprotos/benchmarks/datasets/google_message4;google_message4"},
	}
...
func generateIdentifiers(gen *protogen.Plugin, file *protogen.File) {
	...
	const protoreflectPackage = protogen.GoImportPath("github.com/taogames/protobuf-go/reflect/protoreflect")
