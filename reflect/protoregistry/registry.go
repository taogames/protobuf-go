...
import (
	...
	"github.com/taogames/protobuf-go/internal/encoding/messageset"
...
//
//	go build -ldflags "-X github.com/taogames/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/taogames/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
