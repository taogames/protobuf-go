...
import (
	...
	"github.com/taogames/protobuf-go/internal/strs"
	...
	"github.com/taogames/protobuf-go/types/dynamicpb"
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/taogames/protobuf-go/types/known/anypb";
	//
...
// For example: "github.com/taogames/protobuf-go/compiler/protogen"
